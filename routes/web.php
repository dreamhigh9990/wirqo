...
Route::group(['middleware' => ['auth', 'multi-company-select', 'email_verified'], 'prefix' => 'account'], function () {
	...
	Route::post('proposals/import-files', [ProposalController::class, 'proposalImportFiles'])->name('proposalImportFiles');
	Route::post('estimates/import-files', [EstimateController::class, 'estimatesImportFiles'])->name('estimatesImportFiles');
	Route::post('invoices/import-files', [InvoiceController::class, 'invoicesImportFiles'])->name('invoicesImportFiles');
	Route::post('payments/import-files', [PaymentController::class, 'paymentsImportFiles'])->name('paymentsImportFiles');
	Route::post('creditnotes/import-files', [CreditNoteController::class, 'creditnotesImportFiles'])->name('creditnotesImportFiles');
	Route::post('expenses/import-files', [ExpenseController::class, 'expensesImportFiles'])->name('expensesImportFiles');
